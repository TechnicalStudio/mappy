...
namespace mappy\mappy\fields;

use mappy\mappy\Mappy;
use mappy\mappy\assetbundles\field\FieldAsset;
...
class  extends Field
{
    ...
    public function getSettingsHtml()
    {
        ...
        return Craft::$app->getView()->renderTemplate(
            'mappy/_components/fields/_settings',
            [
                'field' => $this,
            ]
        );
    ...
    public function getInputHtml($value, ElementInterface $element = null): string
    {
        ...
        Craft::$app->getView()->registerJs("$('#{$namespacedId}-field').Mappy(" . $jsonVars . ");");

        // Render the input template
        return Craft::$app->getView()->renderTemplate(
            'mappy/_components/fields/_input',
            [
                'name' => $this->handle,
                'value' => $value,
                'field' => $this,
